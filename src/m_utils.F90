module utils
  ...
  type array1dWrapper
    type(array1d), allocatable :: array(:)
  end type array1dWrapper
  
  type array2dWrapper
    type(array2d), allocatable :: array(:)
  end type array2dWrapper
...
contains
  ...
  subroutine magnitude(input, output)
